export const ResearchProjectFactory = [
  {
    anonymous: false,
    inputs: [
      {
...
export const ResearchProject = [
  ...
  {
    inputs: [],
    name: 'getUnclaimedContributionsAmount',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  },
  {
    inputs: [
      {
        internalType: 'uint128',
        name: 'newContributionMinimum',
        type: 'uint128',
      },
    ],
    name: 'changeMinimumContributionAmount',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
