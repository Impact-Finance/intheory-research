export interface Researcher {
  ...
  name: string;
  avatar: string; // id of image in s3
  affiliation: string;
  degree: string;
  bio: string;
  links: string[];
...
export interface Project {
  id: string; // generated by mongoDB
  name: string;
  researcher: Researcher; // found by researcher id
  tags: string[];
  imageKeywords: string[];
  coverImage: string; // id of image in s3
  shortDescription: string;
  longDescription: string;
  fundingRaised: number;
  associatedArtwork: string[]; // ids of images in s3
